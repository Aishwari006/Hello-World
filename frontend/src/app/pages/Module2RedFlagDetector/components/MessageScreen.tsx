...
export function MessageScreen({
  ...
  return (
    <div className={`min-h-screen flex flex-col transition-all duration-1000 ${getBackgroundStyle()}`}>
      ...
      {/* Title Bar - Updated with Skip to Quiz Button */}
      <div className="px-6 py-4 bg-black/20 backdrop-blur-md border-b border-white/10 flex justify-between items-center">
